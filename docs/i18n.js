...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      v2_funfact: "💡 Fun fact: the 1999 kg XPeng P7+ sedan sits just under 2 tonnes. Fit a tow bar and it tips over — the official Hungarian price list even prints it: 2024 kg with the tow bar. Double fee. A single accessory decides it; countless examples like this show how misguided the idea is.",
    ...
    hu: {
      ...
      v2_funfact: "💡 Fun fact: az 1999 kg-os XPeng P7+ szedán épphogy a 2 tonna alatt van. Szereltess rá egy vonóhorgot, és átlépi — a hivatalos magyar árlista ki is írja: vonóhoroggal 2024 kg. Máris dupla díj. Egyetlen kiegészítő dönt; számtalan ilyen példa mutatja, mennyire elhibázott ez az elképzelés.",
