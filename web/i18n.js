...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      v2_note_hu_only: "⚠ 'HU data only' is ON (Settings) — cars without a Hungarian-source weight are hidden.",
      v2_funfact: "💡 Fun fact: the RAV4 Plug-in Hybrid FWD weighs 1970–1995 kg by Toyota's official Hungarian spec sheet — just under 2 tonnes. Fit a tow bar (e.g. for a bike rack, ~15–25 kg) and its kerb weight tips over — double fee. A single accessory decides it; countless examples like this show how misguided the idea is.",
    ...
    hu: {
      ...
      v2_note_hu_only: "⚠ A 'Csak HU adatok' kapcsoló BE van kapcsolva (Beállítások) — a magyar forrású tömeg nélküli autók rejtve vannak.",
      v2_funfact: "💡 Fun fact: a RAV4 Plug-in Hybrid FWD saját tömege a hivatalos magyar Toyota-árlista szerint 1970–1995 kg — épphogy 2 tonna alatt. Szereltess rá egy vonóhorgot (pl. kerékpárszállításhoz, ~15–25 kg), és átlépi — máris dupla díj. Egyetlen kiegészítő dönt; számtalan ilyen példa mutatja, mennyire elhibázott ez az elképzelés.",
