...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      subtitle: "Budapest weight-based parking fee (from 2027): BEV > 2000 kg, ICE/PHEV > 1800 kg → double",
      ...
      v2_reset_defaults: "↺ Reset to defaults (2000 / 1800)",
      ...
      v2_about: "About",
      v2_about_1: "Curb weights from cars-data.com and katalogus.hasznaltauto.hu. The default 2027 policy is BEV > 2000 kg, ICE/PHEV > 1800 kg.",
    ...
    hu: {
      ...
      subtitle: "Budapesti súlyalapú parkolási díj (2027-től): elektromos > 2000 kg, belső égésű/PHEV > 1800 kg → dupla",
      ...
      v2_reset_defaults: "↺ Alapértékek (2000 / 1800)",
      ...
      v2_about: "Névjegy",
      v2_about_1: "Saját tömegek a cars-data.com és a katalogus.hasznaltauto.hu forrásból. Az alap 2027-es szabály: elektromos > 2000 kg, belső égésű/PHEV > 1800 kg.",
